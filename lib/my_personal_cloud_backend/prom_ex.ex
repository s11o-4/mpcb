defmodule MyPersonalCloudBackend.PromEx do
  @moduledoc """
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     ```
     defmodule MyPersonalCloudBackendWeb.Endpoint do
       use Phoenix.Endpoint, otp_app: :my_personal_cloud_backend

       ...

       plug PromEx.Plug, prom_ex_module: MyPersonalCloudBackend.PromEx
  ...
  use PromEx, otp_app: :my_personal_cloud_backend
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam
      # {Plugins.Phoenix, router: MyPersonalCloudBackendWeb.Router, endpoint: MyPersonalCloudBackendWeb.Endpoint},
      # Plugins.Ecto,
      # Plugins.Oban,
      ...
      # MyPersonalCloudBackend.Users.PromExPlugin
    ]
  end
  ...
  def dashboards do
    [
      ...
      # {:my_personal_cloud_backend, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
